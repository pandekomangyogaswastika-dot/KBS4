...
async def create_invoice(payload: InvoiceIn, user=Depends(require_role("admin", "staff"))):
    ...
    try:
        ...
        print(f"[billing] notify_invoice_created failed: {exc}")
    ...
    try:
        ...
        print(f"[billing] inapp invoice.created failed: {exc}")
...
async def update_invoice(invoice_id: str, payload: InvoicePatch, user=Depends(require_role("admin", "staff"))):
    ...
    if payload.status == "overdue":
        try:
            ...
            print(f"[billing] notify_invoice_overdue failed: {exc}")
    ...
    try:
        ...
        print(f"[billing] inapp invoice.status_changed failed: {exc}")
