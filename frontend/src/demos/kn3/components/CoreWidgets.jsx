...
import { Layers3, ShieldCheck, Menu, X, RefreshCw, LogOut, Sparkles } from "lucide-react";
...
export function TopBar({ title, kicker, onToggleSidebar, onSync, syncing, notice, onShowDetail, infoCta }) {
  return (
