...
export default function AboutPage() {
  ...
  return (
    <div data-testid="about-page">
      <SEOHead
        title="Tentang Kami - Kubus Teknologi Indonesia"
        description="Kubus Teknologi Indonesia adalah partner transformasi digital Anda. Kami membangun software enterprise yang scale dengan fokus pada solusi bisnis."
        type="website"
      />
      ...
      <section className="kti-container py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="kti-heading-1 mb-6">
            {lang.startsWith("en") ? "About Kubus Teknologi Indonesia" : "Tentang Kubus Teknologi Indonesia"}
          </h1>
          <p className="text-xl text-white/70 leading-relaxed">
            {lang.startsWith("en")
              ? "We are a team of passionate engineers and consultants dedicated to building enterprise software that truly solves business problems. Since our founding, we've helped 50+ companies transform digitally with solutions that scale."
              : "Kami adalah tim engineer dan konsultan yang passionate dalam membangun software enterprise yang benar-benar menyelesaikan masalah bisnis. Sejak didirikan, kami telah membantu 50+ perusahaan bertransformasi digital dengan solusi yang scale."}
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="kti-card p-8">
            <h2 className="font-display text-2xl mb-4">
              {lang.startsWith("en") ? "Our Mission" : "Misi Kami"}
            </h2>
          ...
          <div className="kti-card p-8">
            <h2 className="font-display text-2xl mb-4">
              {lang.startsWith("en") ? "Our Vision" : "Visi Kami"}
            </h2>
            <p className="text-white/70 leading-relaxed">
              {lang.startsWith("en")
